...
<div class="row text-center" >
  <%
  	...
  	for(ProductBean product : products){
  		...
  		if(isValidUser){
  			addToCartUrl = "./AddtoCart?uid="+userName+"&pid="+product.getProdId()+"&pqty";
  			buyNowUrl = "./BuyNow?uid="+userName+"&pid="+product.getProdId()+"&pqty";
  		}
  		else{
  ...
  <div class="col-sm-4">
    <div class="thumbnail">
      <img src=<%="./images/"+product.getProdName()+".jpg" %> alt="Product" style="height:200px; max-width:200px; max-width:300px;">
